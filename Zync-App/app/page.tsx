        ...
        <div className="relative z-10 max-w-6xl w-full grid lg:grid-cols-2 gap-8 lg:gap-16 items-center text-white">
          <div>
            ...
            <p className="mt-6 text-lg md:text-xl text-gray-300">
              Zync is great for playing games and chilling with friends, or even building a worldwide community.
...
function FeatureCard({
  ...
  return (
    <div className={`bg-[#2F3136]/40 p-6 rounded-xl border border-[#40444B]/30 hover:bg-[#34373C]/60 transition-colors backdrop-blur-lg ${className}`}>
